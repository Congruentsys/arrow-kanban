...
//! Tests for crates/arrow-kanban/ontology/shapes/research/*.ttl
//!
//! SHACL Shapes — Research Board Item Types (6 types)
//!
...
fn all_shapes_declare_kb_prefix() {
    for (file, _, _, _) in RESEARCH_SHAPE_FILES {
        ...
        assert!(
            content.contains("https://congruentsys.org/ns/arrow-kanban/kanban/"),
            "{file}: kb: must point to <https://congruentsys.org/ns/arrow-kanban/kanban/>"
        );
    }
}
