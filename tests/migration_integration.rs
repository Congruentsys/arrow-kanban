...
//!
//! These tests use synthetic directory trees that mirror a real project's
//! file layout and content patterns.

use arrow_kanban::config::BoardConfig;
use arrow_kanban::migrate::{migrate_board, migrate_boards, parse_markdown_file};
...
namespace: "https://congruentsys.org/ns/arrow-kanban/"
...
"#,
    ...
    assert_eq!(items_batch.num_columns(), 20);
