...
static NU_SY_KANBAN_PATH: &str = "arrow-kanban";

/// Find all .md files in the arrow-kanban/ folder.
...
/// Scan arrow-kanban/ folder for files matching the given search text.
...
/// Derive item type from folder path, e.g. arrow-kanban/research/papers/foo.md → papers
...
"#;
    ...
    fn test_search_files_finds_match() {
        ...
        let arrow_kanban = tmp.path().join("arrow-kanban");
...
"#,
        ...
        let files = collect_md_files(&arrow_kanban);
