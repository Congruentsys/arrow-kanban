...
//! MCP (Model Context Protocol) server for arrow-kanban.
//!
...
mod tests {
    ...
    // Integration tests requiring NATS are in crates/arrow-kanban/tests/.
    ...
    fn test_initialize_response_format() {
        ...
        assert_eq!(response["result"]["serverInfo"]["name"], "arrow-kanban-mcp");
    }
